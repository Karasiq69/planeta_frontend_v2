...
import {OperationType, TransferDocument} from "@/features/inventory-documents/transfer/types";
            ...
            <form id="transferDocumentForm" onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 md:gap-x-16 max-w-6xl">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center gap-3">
                        <Label htmlFor="source-warehouse-select" className="lg:w-32 text-muted-foreground">Отправитель:</Label>
                    ...
                    {/* Операция */}
                    <div className="flex flex-col lg:flex-row lg:items-center gap-3">
                        <Label htmlFor="operationType" className="lg:w-32 text-muted-foreground">Операция</Label>
                        <div className="w-full">
                            <FormField
                                control={form.control}
                                name="operationType"
                    ...
                    {/* Склад назначения */}
                    <div className="flex flex-col lg:flex-row lg:items-center gap-3">
                        <Label htmlFor="destination-warehouse-select" className="lg:w-32 text-muted-foreground">Получатель:</Label>
                        <div className="w-full">
                            <FormField
                                control={form.control}
                    ...
                    {/* Связанный заказ */}
                    <div className="flex flex-col lg:flex-row lg:items-center gap-3">
                        <Label htmlFor="related-order" className="lg:w-32 text-muted-foreground">Связанный заказ:</Label>
                        <div className="w-full">
                            <FormField
                                control={form.control}
                                name="relatedOrderId"
