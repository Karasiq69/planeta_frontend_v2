...
import {UpdateTransferDocumentDto} from "@/features/inventory-documents/transfer/components/forms/schema";
...
const TransferFormContainer = ({documentId}: Props) => {
    ...
    const {mutate: updateDocumentMutation, isPending: isUpdatePending} = useUpdateTransferDocument(documentId);
