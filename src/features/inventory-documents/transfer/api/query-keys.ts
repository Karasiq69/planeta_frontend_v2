...
export const transferDocumentsQueryKeys = {
    ...
    list: (params: ReceiptDocumentsQueryParams) => [...transferDocumentsQueryKeys.lists(), { params }] as const,
    ...
    item: (documentId: number, itemId: number) => [...transferDocumentsQueryKeys.items(documentId), itemId] as const,
};