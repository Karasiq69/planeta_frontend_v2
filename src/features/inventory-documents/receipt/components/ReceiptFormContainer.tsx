...
import {UpdateReceiptDocumentDto} from "@/features/inventory-documents/receipt/components/forms/schema";
...
const ReceiptFormContainer = ({documentId}: Props) => {
    ...
    const {mutate: updateDocumentMutation, isPending: isUpdatePending} = useUpdateReceiptDocument(documentId);
