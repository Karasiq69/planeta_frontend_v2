...
import type { StorageLocation, Warehouse } from '@/features/warehouse/types'
import type { OperationTypeEnum } from '@/helpers'
...
export type InventoryDocumentStatus =
  (typeof InventoryDocumentStatus)[keyof typeof InventoryDocumentStatus]
