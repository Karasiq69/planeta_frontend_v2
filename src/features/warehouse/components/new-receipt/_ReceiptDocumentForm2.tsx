    ...
    <div className='w-full bg-gray-50 p-1 border rounded-md'>
      ...
      <Tabs defaultValue='main'>
        <TabsList className='bg-white border-b border-gray-200 w-full justify-start rounded-none h-8'>
          <TabsTrigger value='main' className='data-[state=active]:bg-gray-100 rounded-none h-8'>
            Основное
          </TabsTrigger>
          <TabsTrigger value='events' className='data-[state=active]:bg-gray-100 rounded-none h-8'>
            События
          </TabsTrigger>
          <TabsTrigger value='files' className='data-[state=active]:bg-gray-100 rounded-none h-8'>
            Файлы
          </TabsTrigger>
          <TabsTrigger
            value='reports'
            disabled
            className='data-[state=active]:bg-gray-100 rounded-none h-8'
          >
            Отчеты
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value='main' className='mt-0 p-4 bg-white border-x border-b'>
          ...
          <div className='flex gap-2 mb-4'>
            <Button className='bg-yellow-500 hover:bg-yellow-600'>Провести и закрыть</Button>
            <Button variant='outline'>Записать</Button>
            <Button variant='outline'>Провести</Button>
          ...
          <div className='grid grid-cols-2 gap-x-4 gap-y-2 mb-4'>
            <div className='flex items-center'>
              <Label htmlFor='supplier' className='w-28'>
                Поставщик:
              </Label>
            ...
            <div className='flex items-center'>
              <Label htmlFor='docNumber' className='w-28'>
                Номер:
              </Label>
              <div className='flex-1 flex gap-1'>
            ...
            <div className='flex items-center'>
              <Label htmlFor='contract' className='w-28'>
                Договор:
              </Label>
              <div className='flex-1 flex gap-1'>
                <Select>
            ...
            <div className='flex items-center'>
              <Label htmlFor='extNumber' className='w-28'>
                Вх. номер:
              </Label>
              <div className='flex-1 flex gap-1'>
            ...
            <div className='flex items-center'>
              <Label htmlFor='order' className='w-28'>
                Заказ:
              </Label>
              <div className='flex-1 flex gap-1'>
                <Select disabled>
            ...
            <div className='flex items-center'>
              <Label htmlFor='operation' className='w-28'>
                Операция:
              </Label>
            ...
            <div className='flex items-center'>
              <Label htmlFor='warehouse' className='w-28'>
                Склад:
              </Label>
              <div className='flex-1 flex gap-1'>
                <Select>
            ...
            <div className='flex items-center'>
              <Label htmlFor='organization' className='w-28'>
                Организация:
              </Label>
              <div className='flex-1 flex gap-1'>
                <Select>
