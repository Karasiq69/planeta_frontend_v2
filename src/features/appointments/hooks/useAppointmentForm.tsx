...
import { appointmentSchema } from '../components/forms/schema'

import type { AppointmentFormData } from '../components/forms/schema';
...
export const useAppointmentForm = ({
  ...
  const defaultValues = useMemo(() => {
    return {
      ...
      end: (appointmentData?.end as Date)
        ? (appointmentData?.end as Date)
        : (appointmentData?.start as Date),
