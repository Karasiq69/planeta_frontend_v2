...
const SuppliersCombobox: React.FC<SuppliersComboboxProps> = ({
    ...
    const [selectedSupplierId, setSelectedSupplierId] = useState<string>(initialValue?.toString() || "");
    ...
    return (
        <AsyncSelect<Supplier>
            ...
            filterFn={(supplier, query) => {
                ...
                const innMatch = supplier.inn ? supplier.inn.toLowerCase().includes(query.toLowerCase()) : false;
