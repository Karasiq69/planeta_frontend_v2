...
import {AlertCircle, Bell, Calendar, Car, PenTool} from "lucide-react";
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                <div className="border rounded-lg p-4">
                                    ...
                                    <p className="text-sm text-gray-500 mt-1">Замена масла, фильтров, диагностика ходовой части</p>
                                </div>
