                ...
                <div className="grid gap-6 md:grid-cols-2">
                    <div>
                        <div className="space-y-2 text-sm">
                            <p><span className="text-gray-500">ФИО:</span> {`${firstName} ${lastName}`}</p>
                    ...
                    <div>
                        <div className="space-y-2 text-sm">
                            <p><span className="text-gray-500">Предпочтительное время:</span> После 17:00</p>
                            <p><span className="text-gray-500">Дата регистрации:</span> 15.03.2023</p>
                            <div><span className="text-gray-500">Статус:</span> <Badge>VIP клиент</Badge></div>
                        </div>
                    </div>
                </div>
            </CardContent>
