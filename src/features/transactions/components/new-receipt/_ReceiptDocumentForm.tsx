                ...
                <CardHeader className={'max-w-6xl'}>
                    ...
                    <div className="grid lg:grid-cols-2 gap-x-20 gap-y-2 mb-4">
                        <div className="flex items-center">
                            <Label htmlFor="supplier" className="w-28 text-muted-foreground">Поставщик:</Label>
                        ...
                        <div className="flex items-center">
                            <Label htmlFor="docNumber" className="w-28 text-muted-foreground">Номер:</Label>
                        ...
                        <div className="flex items-center">
                            <Label htmlFor="contract" className="w-28 text-muted-foreground">Договор:</Label>
                            <div className="flex-1 flex gap-1 items-center">
                                <Select>
                                    <SelectTrigger className="flex-1">
                                        <SelectValue placeholder="Выберите договор"/>
                        ...
                        <div className="flex items-center">
                            <Label htmlFor="extNumber" className="w-28 text-muted-foreground">Вх. номер:</Label>
                            <div className="flex-1 flex gap-1 items-center">
                        ...
                        <div className="flex items-center">
                            <Label htmlFor="order" className="w-28 text-muted-foreground">Заказ:</Label>
                            <div className="flex-1 flex gap-1">
                                <Select disabled>
                                    <SelectTrigger className="flex-1">
                        ...
                        <div className="flex items-center">
                            <Label htmlFor="operation" className="w-28 text-muted-foreground">Операция:</Label>
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="flex-1 flex gap-1">
                                <Select defaultValue="marinin">
                                    ...
                                    <SelectContent
                                        className={'className="[&_*[role=option]>span>svg]:shrink-0 [&_*[role=option]>span>svg]:text-muted-foreground/80 [&_*[role=option]>span]:end-2 [&_*[role=option]>span]:start-auto [&_*[role=option]>span]:flex [&_*[role=option]>span]:items-center [&_*[role=option]>span]:gap-2 [&_*[role=option]]:pe-8 [&_*[role=option]]:ps-2"'}>
                                        <SelectItem value="marinin" className={'flex gap-2'}>
                                            <Warehouse size={16} aria-hidden="true"/>
                                            Склад Маринин А.С.
                                        </SelectItem>
