...
import {CreateComment, TComment, UpdateComment} from "@/features/orders/comments/types";
...
// Update a comment
export const updateCommentFn = async ({id, ...data}: UpdateComment & { id: number }): Promise<TComment> => {
