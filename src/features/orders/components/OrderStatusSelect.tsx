    ...
    <div>
      ...
      <div className='flex items-center gap-1'>
        <div className='inline-flex -space-x-px rounded-lg shadow-xs shadow-black/5 rtl:space-x-reverse'>
          <Button
            className={cn(
              'rounded-none shadow-none first:rounded-s-lg last:rounded-e-lg focus-visible:z-10 group',
              nextStatusColor
            )}
            variant='outline'
          ...
          >
            <SelectTrigger className='rounded-none shadow-none first:rounded-s-lg last:rounded-e-lg focus-visible:z-10'></SelectTrigger>
            <SelectContent>
              <SelectGroup>
                {statuses.map((status) => (
